<x-admin-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-warm-white">Tambah Kategori Baru</h2>
                <p class="mt-1 text-sm text-warm-gray">Isi formulir di bawah untuk menambahkan kategori baru</p>
            </div>
        </div>
