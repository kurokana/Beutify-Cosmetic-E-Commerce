<x-admin-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-warm-white">Edit Produk</h2>
                <p class="mt-1 text-sm text-warm-gray">Perbarui informasi produk {{ $product->name }}</p>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            @foreach ($product->images as $image)
                                <div class="relative group rounded-lg overflow-hidden border border-border-subtle">
                                    <img
