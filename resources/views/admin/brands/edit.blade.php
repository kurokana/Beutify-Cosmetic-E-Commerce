<x-admin-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Edit Merek</h2>
                <p class="mt-1 text-sm text-gray-600">Perbarui informasi merek {{ $brand->name }}</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                @if ($brand->logo_path)
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="h-24 w-24 rounded-lg border-2 border-gray-300 overflow-hidden bg-gray-50">
                                <img
