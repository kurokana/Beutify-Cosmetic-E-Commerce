    ...
    <div class="max-w-md w-full bg-dark-secondary rounded-2xl shadow-xl border border-border-subtle p-8">
        <div class="text-center mb-6">
            <h2 class="text-2xl font-black tracking-tight">
                <span class="text-gold-light">Verifikasi</span>
        ...
        <div class="mt-6 flex flex-col gap-3">
            <form method="POST" action="{{ route('verification.send') }}">
                ...
                <button type="submit" class="w-full bg-gold hover:bg-[#d45a92] rounded-full px-6 py-2 font-semibold text-white transition">
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit" class="w-full text-center text-sm text-gold-light hover:text-gold transition-colors">
                    Keluar
                </button>
            </form>
        </div>
